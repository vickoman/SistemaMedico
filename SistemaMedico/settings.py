"""
Django settings for SistemaMedico project.
...
SECRET_KEY = 'j+(%$f-(ebiz78_up!b#p761%1nqz&yf&5q=y))a3i*&ml@ndv'
...
ROOT_URLCONF = 'SistemaMedico.urls'

WSGI_APPLICATION = 'SistemaMedico.wsgi.application'
